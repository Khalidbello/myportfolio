...
const About: React.FC = () => {
    return (
        <div id="about" className="relative bg-bg2 w-full bg-opacity-90">
            <Image alt="About pattern iamge" src={'/bg-pattern.png'} width={500} height={500} className="-z-[1] absolute top-0 heght-0 w-full h-full" />
                ...
                <div className="flex items-center justify-center ralative -mt-[7.5rem] mb-20 bg-gray-600 bg-opacity-0">
                    <div className="h-[5rem] font-mono inline-flex justify-center items-center gap-5 mx-10 rounded-full bg-gray-900 p-4">
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <span className="text-gray-200 text-xs font-mono">Years Of Experience</span>
                        </div>
                        <div className="flex items-center justify-center gap-2">
                            <span className="text-prmry1 text-[2rem]">4</span>
                            <span className="text-gray-200 text-xs font-mono">Live Projects</span>
                        </div>
                        <div className="flex items-center justify-center gap-2">
                            <span className="text-prmry1 text-[2rem]">3</span>
                            <span className="text-gray-200 text-xs font-mono">Programming Languages</span>
                        </div>
                    </div>
                </div>
                <Topper />
