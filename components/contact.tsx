...
const Contact = () => {
    return (
        <div id="contact" className="relative bg-bg2 w-full bg-opacity-20">
            <div className="py-20">
                <Topper />
                <TopperText
                    head={'Contact'}
                    note={'Currently available t bring your thoughts to live'}
                />
                <div className="mt-16">
                    ...
                    <form action="" className="block max-w-xl mx-auto">
                        <div className="flex items-center justify-between flex-grow gap-x-10 mb-8">
                            <div className="flex flex-col items-start justify-start gap-y-2 w-[40%]">
                        ...
                        <div className="flex items-center justify-center">
                            <button className="px-4 py-2 rounded-full bg-prmry1 text-gray-600 flex items-center justify-center gap-3">
